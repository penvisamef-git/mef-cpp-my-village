...
const route = (prop) => {
  ...
  prop.app.put(
    ...
    async (req, res) => {
      try {
        const { id } = req.params;
        const { tittle, article, remove_images , challenge_type_id} = req.body;
        ...
        if(challenge_type_id) updatedData.challenge_type_id = challenge_type_id
